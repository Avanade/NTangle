...
namespace {{Root.NamespacePublisher}}.Services
{
    ...
    public partial class {{Model}}HostedService : HostedService<I{{Model}}CdcOrchestrator, {{Model}}Cdc>
    {
        ...
        public {{Model}}HostedService(IServiceProvider serviceProvider, ILogger<{{Model}}HostedService> logger, IConfiguration config, IHostedServiceSynchronizer synchronizer) : base(serviceProvider, logger, config, synchronizer) { }
    }
}
