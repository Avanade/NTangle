...
namespace ContactSync.NewApp.Database;
...
public class Program
{
    ...
    public static async Task<int> Main(string[] args) => await SqlServerMigrationConsole
        .Create<Program>("Data Source=.;Initial Catalog=ContactSync.NewApp;Integrated Security=True;TrustServerCertificate=true")
