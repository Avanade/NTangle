...
namespace SqlServerDemo.CodeGen
{
    internal class Program
    {
        ...
        public static async Task<int> Main(string[] args) => await CodeGenConsole.Create("Data Source=.;Initial Catalog=NTangleDemo;Integrated Security=True").UseSqlServer().RunAsync(args).ConfigureAwait(false);
    }
}