...
namespace SqlServerDemo.CodeGen
{
    internal class Program
    {
        ...
        public static async Task<int> Main(string[] args) => await new CodeGenConsole("Data Source=.;Initial Catalog=NTangleDemo;Integrated Security=True").UseSqlServer(SqlServerDeployment.DbEx).RunAsync(args).ConfigureAwait(false);
    }
}