...
namespace AppName.SidecarDb;

/// <summary>
/// <see href="https://github.com/Avanade/DbEx">DbEx</see>-based "sidecar" database deployment migration console program.
/// </summary>
public class Program
{
    ...
    public static async Task<int> Main(string[] args) => await SqlServerMigrationConsole
        .Create<Program>("Data Source=.;Initial Catalog=DomainName_Sidecar;Integrated Security=True;TrustServerCertificate=true")
