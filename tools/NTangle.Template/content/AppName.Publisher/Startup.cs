...
public class Startup : HostStartup
{
    ...
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services
            ...
            .AddDatabase(sp => new SqlServerDatabase(() => new SqlConnection(sp.GetRequiredService<DomainNameSettings>().SourceDbConnectionString)))
            .AddSidecarDatabase(sp => new SqlServerSidecarDatabase(() => new SqlConnection(sp.GetRequiredService<DomainNameSettings>().SidecarDbConnectionString)))
            .AddExecutionContext()
            .AddJsonSerializer();
        ...
        services
            ...
            {
                EventOutboxDequeueFactory = sp => new EventOutboxDequeue(sp.GetRequiredService<ISidecarDatabase>(), sp.GetRequiredService<ServiceBusSender>(), sp.GetRequiredService<ILogger<EventOutboxDequeue>>())
            });
    }
}
#else
